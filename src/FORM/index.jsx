...
class Form extends Component {
    ...
    componentDidUpdate(prevProps) {
        ...
        const { editUser } = prevProps; //nextProps: hiện tất cả các props được truyền qua, nên cần chọn cái nào thì lấy cái đó ra ngoài, (tham số mặc định)


        if (editUser !== this.props.editUser) {
            this.setState({
